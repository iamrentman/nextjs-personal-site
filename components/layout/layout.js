        ...
        <ul className={styles.iconList}>
          ...
          <li>
            <a href="https://github.com/iamrentman">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.579 31.775" className={classnames( styles.iconSocial, styles.iconGitHub)}>
          ...
          <li>
            <a href="https://codepen.io/iamrentman">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.775 31.775" className={classnames( styles.iconSocial, styles.iconCodePen)}>
