...
I saw an amazing presentation by Miriam Suzanne at Design 4 Drupal 2019 where she really displayed the power of CSS Custom Properties. We're using them on the project mentioned above but, to be honest, I don't fully understand them. This ought to be a good place to learn and practice.

## Variable fonts
At NEDCamp 2019, Jason Pamental presented an intriguing session called [_Typographic Design Innovation with Modern CSS & Variable Fonts_](https://www.youtube.com/watch?v=UoAnMhQag-8&list=PLgfWMnl57dv5MzfALebolOvmdRbxFDFc7&index=20). As a designer at heart, nothing excites me more than the progress made recently with web typography. This site is super cool. Right now on this site you are reading the variable version of [Literata](https://fonts.google.com/specimen/Literata).

## Dark mode
I'm a dark mode fan all around. I think the `prefers-color-scheme` media query is pretty neat. I've got it working on an extremely basic level right now, but I endeavor to play with this a bit.
