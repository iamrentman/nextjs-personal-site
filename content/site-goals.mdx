...
I've decided I don't need a CMS for my personal site so I'm abandoning that all together and going straight up Next for now and working with MDX to author content. With the simple push-to-Github-to-deploy-changes-in-30-seconds that is possible with Vercel (or other cloud hosts), publishing and updating is so quick and simple right from the command line.
